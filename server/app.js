...
const questionsRouter = require("./routers/interview_questions");
...
// * MongoDB connection
const url = `mongodb+srv://daniel_mongo_user:${process.env.PASSWORD}@cluster0.xx3io.mongodb.net/interview?retryWrites=true&w=majority`;
...
app.use("/interviewQ", questionsRouter);
